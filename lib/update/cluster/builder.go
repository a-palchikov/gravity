...
// migrationPhase constructs a migration phase based on the plan params.
//
...
func (r phaseBuilder) newPlan() *storage.OperationPlan {
	var root builder.Phase
